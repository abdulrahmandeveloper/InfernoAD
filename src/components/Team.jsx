    ...
    <section className="container mx-auto px-8 py-20" id="team">
      ...
      <div className="flex flex-wrap">
        ...
        <div className="w-full flex justify-center mt-12 ">
          <button className="flex items-center gap-2 px-8 py-4 font-semibold rounded-full bg-emerald-950 text-orange-50 hover:bg-emerald-900  duration-300 cursor-pointer hover:translate-x-1 transition-transform">
            See more
